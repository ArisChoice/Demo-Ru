...
import com.app.rum_a.ui.postauth.qbloxui.quickbloxmodule.adapter.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable, QBRTCClientVideoTracksCallbacks,
    ...
    public void setDuringCallActionBar() {
        ...
        if (isPeerToPeerCall) {
            ...
            actionBar.setSubtitle(getString(R.string.opponents, 1));
        }
...
//                Toaster.shortToast(getString(R.string.camera_swicth_failed) + s);
                CommonUtils.getInstance(getActivity()).ShowToast(getString(R.string.camera_swicth_failed) + s);
