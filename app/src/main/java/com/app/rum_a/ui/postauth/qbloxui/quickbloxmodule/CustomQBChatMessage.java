...
/**
 * Created by Vivek on 20-04-2017.
 */

public class CustomQBChatMessage implements Serializable {
    private String _id;
    ...
    private  boolean isDeletionActivate;

    public boolean isDeletionActivate() {
        return isDeletionActivate;
    }

    public void setDeletionActivate(boolean deletionActivate) {
        isDeletionActivate = deletionActivate;
    }

    public CustomQBChatMessage() {
        this._id = MongoDBObjectId.get().toString();
    }

    public CustomQBChatMessage(Message smackMessage) {
