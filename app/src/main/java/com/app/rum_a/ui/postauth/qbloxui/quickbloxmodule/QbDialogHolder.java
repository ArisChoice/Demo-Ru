...
public class QbDialogHolder {
    ...
    private Map<String, QBChatDialog>
    getSortedMap(Map<String, QBChatDialog> unsortedMap) {
        Map<String, QBChatDialog> sortedMap = new TreeMap(new LastMessageDateSentComparator(unsortedMap));
        sortedMap.putAll(unsortedMap);
        return sortedMap;
    }

    public QBChatDialog updateDialog(String dialogId, QBChatMessage qbChatMessage) {
